...
Dari 15 kali percobaan yang dilakukan 1 kali percobaan gagal menemukan rute akibat waktu dan yang tidak ada. Maka gerbang tutup pada jam ini sehinggga rute tidak bisa diakses. 14 kali percobaan berhasil menemukan rute, namun masing-masing percobaan menghasilkan jalur yang berbeda-beda sesuai dengan lokasi awal dan lokasi tujuan yang diinginkan. Hal ini menunjukkan bahwa meskipun BFS berhasil menemukan rute, setiap rute yang dihasilkan tidak selalu sama tergantung pada struktur graf saat itu dan urutan pemrosesan simpul. Rute yang berbeda-beda ini secara tidak langsung dapat menghasilkan jalur yang lebih optimal atau lebih pendek dibandingkan percobaan sebelumnya, meskipun BFS sendiri tidak mempertimbangkan bobot atau jarak, hanya mencari rute dengan jumlah simpul minimum.tetapi yang kami gunakan ini menggunakan bobot atau jarak agar bisa memperkirakan watku tempuh dan rute terdekatnya.
